...
Router.route('/admin/menu_management/edit_menu_items',{
    ...
    action(){
        if(Meteor.userId()) {
            BlazeLayout.render('admin_index',{content: 'menu_management', menu_content: 'edit_menu_items'});
        }else{
            BlazeLayout.render('master_layout',{body: 'no_access'});
        }
    }
...
Router.route('/admin/menu_management/add_menu_items',{
    ...
    action(){
        if(Meteor.userId()) {
            BlazeLayout.render('admin_index',{content: 'menu_management', menu_content: 'add_menu_items'});
        }else{
            BlazeLayout.render('master_layout',{body: 'no_access'});
        }
    }
