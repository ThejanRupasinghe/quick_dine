Router.route('/admin/dashboard',{
    ...
    action(){
        if( (! Meteor.userId() )|| Meteor.user().profile.role !== "admin") {
            ...
            var data = {};
            data.orders_no = Orders.find().count();
            data.users_no = Meteor.users.find().count();

            BlazeLayout.render('admin_index',{content: 'dashboard', data: data});
        }
    }
});
...
Router.route('/admin/reports/satisfaction',{
    name: 'admin_reports_satisfaction',
    onBeforeAction: function () {
        $('body').addClass("hold-transition skin-yellow sidebar-mini");
        ...
        $('head').append('<link rel="stylesheet" href="/admin/dist/css/skins/skin-yellow.min.css">');
        // <!-- Chart JS -->
        $.getScript("/admin/plugins/chartjs/Chart.min.js");
        // <!-- Date Picker -->
        $('head').append('<link rel="stylesheet" href="/admin/plugins/datepicker/datepicker3.css">');
    ...
    action(){
        ...
        if((! Meteor.userId() )|| Meteor.user().profile.role !== "admin") {
            ...
            BlazeLayout.render('admin_index',{content: 'report_satisfaction'});
        }
    }
});

Router.route('/admin/reports/summary',{
    name: 'admin_reports_summary',
    onBeforeAction: function () {
        $('body').addClass("hold-transition skin-yellow sidebar-mini");
    ...
    action(){
        ...
        if((! Meteor.userId() )|| Meteor.user().profile.role !== "admin") {
            ...
            BlazeLayout.render('admin_index',{content: 'report_summary'});
        }
    }
});